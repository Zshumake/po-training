...
class _QuizSessionViewState extends State<QuizSessionView> {
  ...
  void _showResults() {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text('Quiz Complete!', style: TextStyle(color: AppTheme.textPrimary)),
        content: Column(
        ...
        actions: [
          TextButton(
            ...
            child: const Text('Done', style: TextStyle(color: AppTheme.accentTeal)),
          ),
        ],
      ),
    );
  ...
  Color _getOptionColor(int index) {
    if (!_answered) return AppTheme.surfaceDark;
    if (index == _currentQuestion.correctIndex) return const Color(0xFF0D2818);
    if (index == _selectedIndex) return const Color(0xFF2A1519);
