                ...
                child: AnimatedSwitcher(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: _showBack ? AppTheme.surfaceElevated : AppTheme.surfaceDark,
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                        color: _showBack ? AppTheme.accentTeal.withValues(alpha: 0.3) : AppTheme.surfaceBorder,
                        width: 2,
                      ),
                      boxShadow: [
                        BoxShadow(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            letterSpacing: 1.5,
                            color: _showBack ? AppTheme.accentTeal : AppTheme.textTertiary,
                          ),
                        ),
